...
void AMKInverter_runLogging_10ms(void) 
{
	...
	amk_setpoint1_fl.s.AMK_Torque_setpoint = INV_FL_AMK_Setpoint1.S.AMK_Torque_setpoint;
	...
	amk_setpoint1_fr.s.AMK_Torque_setpoint = INV_FL_AMK_Setpoint1.S.AMK_Torque_setpoint;
